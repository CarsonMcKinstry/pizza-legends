...
import CombatantPlate from "../images/ui/combatant-plate.png";
import PizzaShadow from "../images/characters/pizzas/pizza-shadow.png";
...
export class Combatant {
  ...
  createElement() {
    ...
    this.hudElement.style.backgroundImage = `url(${CombatantPlate})`;
    ...
    this.pizzaElement.style.backgroundImage = `url(${PizzaShadow})`;
